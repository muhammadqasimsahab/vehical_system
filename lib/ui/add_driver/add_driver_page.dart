...
class AddDriverPage extends StatefulWidget {
  AddDriverPage({Key? key}) : super(key: key);
            ...
            child: Column(
              ...
              children: [
                ...
                UserNameTextFiled(
                  ...
                  hint: 'Phone',
                  icon: Icon(Icons.phone,color: _focusNodes[0].hasFocus ? AppColors.primaryColor : Colors.grey.shade300,),
                  visiable: false,
                ),
                       SizedBox(height: 3.h),
                UserNameTextFiled(
                  ...
                  hint: 'Forer#',
                  icon: Icon(Icons.numbers,color: _focusNodes[0].hasFocus ? AppColors.primaryColor : Colors.grey.shade300,),
                  visiable: false,
                ),
                      SizedBox(height: 5.h),
                Button(
